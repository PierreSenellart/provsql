...
ProvSQL has been developed primarily within the [Valda](https://team.inria.fr/valda/) research team, under the lead of [Pierre Senellart](https://pierre.senellart.com).

<div class="institution-logos">
  <a href="https://www.ens.psl.eu/"><img src="/assets/images/institutions/ens-psl.png" alt="ENS-PSL"></a>
  <a href="https://www.cnrs.fr/"><img src="/assets/images/institutions/cnrs.svg" alt="CNRS"></a>
  <a href="https://www.inria.fr/"><img src="/assets/images/institutions/inria.svg" alt="Inria"></a>
</div>
...
<div class="grant-entry">
  {% if grant.logo %}<div class="grant-logo"><a href="{{ grant.url }}"><img src="/assets/images/grants/{{ grant.logo }}" alt="{{ grant.name }}"></a></div>{% endif %}
  <h3 id="{{ grant.name | slugify }}">{% if grant.url %}<a href="{{ grant.url }}">{{ grant.name }}</a>{% else %}{{ grant.name }}{% endif %}</h3>
  <table class="grant-meta">
    ...
    {% if grant.url %}<tr><th>Website</th><td><a href="{{ grant.url }}">{{ grant.url }}</a></td></tr>{% endif %}
  </table>
</div>
